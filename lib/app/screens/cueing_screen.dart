              ...
              : ListView(
                  ...
                  children: [
                    SectionCard(
                      ...
                      trailing: Chip(label: Text(frame.cueMode.label)),
                      child: Column(
                      ...
                      child: Column(
                        children: [
                          _CueTile(
                            ...
                            active: frame.cueMode == CueMode.haptic ||
                          ...
                          _CueTile(
                            ...
                            active: frame.cueMode == CueMode.audio ||
                                frame.cueMode == CueMode.multisensory,
                          ),
                          const SizedBox(height: 12),
                          _CueTile(
                            ...
                            active: frame.cueMode == CueMode.laser ||
                                frame.cueMode == CueMode.multisensory,
                          ),
                        ],
                      ),
                    ...
                    SectionCard(
                      ...
                      child: Column(
                        children: [
                          _ParameterRow(label: '개인 템포', value: '${frame.cadenceBpm} BPM'),
                          _ParameterRow(
                            label: 'Freeze Index',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: active ? StepOnColors.blue.withValues(alpha: 0.08) : Colors.white,
        border: Border.all(
        ...
        children: [
          CircleAvatar(
            backgroundColor: active
                ? StepOnColors.blue.withValues(alpha: 0.14)
                : StepOnColors.ice,
            child: Icon(
              icon,
