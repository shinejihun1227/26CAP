> 전체/개별 실행·설치·종료는 [통합 실행 안내](RUNNING.md)를 참고하세요.

> 웹 CSV 업로드와 실제 센서 기록 기능이 추가되었습니다. [데이터 수집 → CSV → AI 연결 안내](DATA_PIPELINE.md)를 참고하세요.

# AI 엔진 교체 및 웹 연동 — 2026-09-14

## 실행

1. 첫 설치: 저장소 루트에서 `setup-ai.bat` 실행. Python 3.12와 Node.js 24 LTS을 사용합니다.
