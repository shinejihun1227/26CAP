...
export function renderRecordsContent() {
  return `<section class="records-workspace">
    <header class="simple-heading"><div><span class="simple-eyebrow">자료 보관</span><h1>데이터 관리</h1><p>측정 세트와 저장된 자료를 한곳에서 관리하세요.</p></div><a class="simple-secondary" href="/data/">다섯 동작 수집 안내 · CSV 분석 ↗</a></header>
