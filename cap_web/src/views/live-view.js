    ...
    <div class="page-shell clarity-page">
      ...
      <main class="content-area clarity-content">`}
        ...
        <section class="clarity-live-hero">
          <div><span class="clarity-live-badge"><i></i>${state.paused ? "측정 일시정지" : state.connected ? "측정 중" : "연결 대기"}</span><h2>${state.paused ? "측정을 잠시 멈췄어요" : streamTitle}</h2><p>마지막 수신 ${state.device.lastSync}</p></div>
