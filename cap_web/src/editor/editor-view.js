...
const DIRECT_PREVIEW_BLOCKS = {
  ...
  overview: [
    ...
    { id: "metric-steps", selector: ".metrics-grid [data-metric=steps]", fields: { title: ".metric-label", description: ".metric-foot > span:last-child" } },
    { id: "metric-balance", selector: ".metrics-grid [data-metric=balance]", fields: { title: ".metric-label", description: ".metric-foot > span:last-child" } },
    { id: "metric-temp", selector: ".metrics-grid [data-metric=temperature]", fields: { title: ".metric-label", description: ".metric-foot > span:last-child" } },
    { id: "metric-humidity", selector: ".metrics-grid [data-metric=humidity]", fields: { title: ".metric-label", description: ".metric-foot > span:last-child" } },
